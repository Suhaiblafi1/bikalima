                ...
                <div className="relative z-10">
                  ...
                  <div className="space-y-6">
                    <a href="https://wa.me/97455377065" target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 group cursor-pointer">
                      ...
                      <div>
                        <p className="text-sm text-primary-foreground/60">{lang === "ar" ? "تواصل عبر واتساب" : lang === "fr" ? "Contactez via WhatsApp" : "Chat on WhatsApp"}</p>
                        <p className="font-bold text-lg group-hover:underline" dir="ltr">+974 5537 7065</p>
                      </div>
                    </a>
