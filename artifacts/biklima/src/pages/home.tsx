  ...
  return (
    <div className="min-h-screen bg-background text-foreground font-sans overflow-x-hidden relative" dir={dir}>
      ...
      <main id="main-content" tabIndex={-1}>
        ...
        <section id="enroll" className="py-10 md:py-16 bg-secondary/20 border-t border-border">
          <div className="container mx-auto px-4 sm:px-6">
            <div className="max-w-5xl mx-auto bg-card rounded-3xl shadow-lg overflow-hidden border border-border/60 grid lg:grid-cols-3">
              ...
              <div className="bg-primary text-primary-foreground p-7 hidden lg:flex flex-col justify-between relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <h3 className="font-serif text-2xl font-bold mb-3 leading-tight whitespace-pre-line">{t.enroll.sidePanelTitle}</h3>
                  <p className="text-primary-foreground/75 text-sm leading-relaxed mb-5">{t.enroll.sidePanelText}</p>
                  ...
                  <div className="mb-5 space-y-0">
                    {[
                      ...
                      <div key={i} className="flex items-start gap-3 py-2.5 border-b border-primary-foreground/10 last:border-0">
                        <span className="text-lg font-bold font-serif text-primary-foreground/25 leading-none shrink-0 mt-0.5">{step.num}</span>
                        <div>
                  ...
                  <div className="rounded-2xl bg-primary-foreground/10 border border-primary-foreground/15 p-4 space-y-3">
                    <p className="font-bold text-sm">{lang === "ar" ? "هل لديك سؤال؟" : "Have a question?"}</p>
