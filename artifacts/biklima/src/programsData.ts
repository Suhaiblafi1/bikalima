  ...
  },
  {
    ...
    i18n: {
      en: {
        ...
        description: "An advanced qualification program to prepare certified trainers capable of delivering the Biklima program for adults professionally. It focuses on building the trainer's identity, understanding the program philosophy, mastering training tools, and managing sessions and groups.",
        ...
        outcomes: ["Professional training methodology", "Training session design", "Group management and facilitation", "Official Biklima certification", "Building a training career track", "Implementation and market launch"],
        modules: ["From Speaker to Trainer", "Biklima Program Philosophy and Impact", "The Trainer's Personality and Professional Identity", "Training Session Design", "Group Management and Facilitation", "Building Activities and Applications", "Impactful Presentation in Front of an Audience", "Persuasion and Crafting the Message", "Delivering Trial Sessions", "Feedback and Professional Assessment", "Standards of the Certified Trainer", "Market Launch Plan"],
        workbook: { title: "Biklima – The Certified Trainer Program", description: "The comprehensive professional guide for the certified trainer, including complete curricula, tools, and assessments" },
      },
      fr: {
        ...
        outcomes: ["Méthodologie de formation professionnelle", "Conception de séances de formation", "Gestion de groupe et facilitation", "Certification officielle Biklima", "Construction d'un parcours de formation", "Mise en œuvre et lancement sur le marché"],
        ...
        workbook: { title: "Biklima – Le Programme du Formateur Certifié", description: "Le guide professionnel complet pour le formateur certifié, incluant les curricula, outils et évaluations complets" },
      },
    },
  },
  {
    ...
    i18n: {
      en: {
        ...
        shortTitle: "Biklima for Educators & Parents",
        ...
        workbook: { title: "Biklima Program for Educators & Parents", description: "A specialized training kit with strategies and practical activities to build a confident generation" },
      },
      fr: {
        role: "Éducateurs & Parents",
        shortTitle: "Biklima pour Éducateurs & Parents",
        ...
        workbook: { title: "Programme Biklima pour Éducateurs & Parents", description: "Un kit de formation spécialisé avec des stratégies et des activités pratiques pour construire une génération confiante" },
      },
    },
  },
  {
