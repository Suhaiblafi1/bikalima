...
const programsBase: Program[] = [
  ...
  },
  {
    ...
    shortTitle: "تأهيل المعلمين لتعليم الأطفال - الخطابة والإلقاء",
    ...
    i18n: {
      en: {
        ...
        shortTitle: "Qualifying Educators to Teach Children - Public Speaking",
      ...
      fr: {
        ...
        shortTitle: "Former les Enseignants pour les Enfants - Art Oratoire",
