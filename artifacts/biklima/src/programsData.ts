  ...
  },
  {
    ...
    i18n: {
      en: {
        ...
        description: "An advanced qualification program to prepare certified trainers capable of delivering the Bakalima program for adults professionally. It focuses on building the trainer's identity, understanding the program philosophy, mastering training tools, and managing sessions and groups.",
        ...
        outcomes: ["Professional training methodology", "Training session design", "Group management and facilitation", "Official Bakalima certification", "Building a training career track", "Implementation and market launch"],
        modules: ["From Speaker to Trainer", "Bakalima Program Philosophy and Impact", "The Trainer's Personality and Professional Identity", "Training Session Design", "Group Management and Facilitation", "Building Activities and Applications", "Impactful Presentation in Front of an Audience", "Persuasion and Crafting the Message", "Delivering Trial Sessions", "Feedback and Professional Assessment", "Standards of the Certified Trainer", "Market Launch Plan"],
        workbook: { title: "Bakalima – The Certified Trainer Program", description: "The comprehensive professional guide for the certified trainer, including complete curricula, tools, and assessments" },
      },
      fr: {
        ...
        outcomes: ["Méthodologie de formation professionnelle", "Conception de séances de formation", "Gestion de groupe et facilitation", "Certification officielle Bakalima", "Construction d'un parcours de formation", "Mise en œuvre et lancement sur le marché"],
        modules: ["De l'Orateur au Formateur", "Philosophie et Impact du Programme Bakalima", "La Personnalité du Formateur et son Identité Professionnelle", "Conception de Séances de Formation", "Gestion de Groupes et Facilitation", "Construire des Activités et Applications", "Présentation Impactante devant un Public", "Persuasion et Création du Message", "Animer des Séances d'Essai", "Retour d'Information et Évaluation Professionnelle", "Critères du Formateur Certifié", "Plan de Lancement sur le Marché"],
        workbook: { title: "Bakalima – Le Programme du Formateur Certifié", description: "Le guide professionnel complet pour le formateur certifié, incluant les curricula, outils et évaluations complets" },
      },
    },
  },
  {
    ...
    i18n: {
      en: {
        ...
        shortTitle: "Bakalima for Educators & Parents",
        ...
        workbook: { title: "Bakalima Program for Educators & Parents", description: "A specialized training kit with strategies and practical activities to build a confident generation" },
      },
      fr: {
        role: "Éducateurs & Parents",
        shortTitle: "Bakalima pour Éducateurs & Parents",
        ...
        workbook: { title: "Programme Bakalima pour Éducateurs & Parents", description: "Un kit de formation spécialisé avec des stratégies et des activités pratiques pour construire une génération confiante" },
      },
    },
  },
  {
...
export const testimonials: Record<Lang, { name: string; role: string; quote: string }[]> = {
  ...
  en: [
    ...
    { name: "Mariam Waache", role: "Marketing Director", quote: "The Influential Speaker program changed the way I deal with clients. I now know how to convey my idea in seconds and leave a real impression in any meeting." },
  ...
  fr: [
    ...
    { name: "Mariam Waache", role: "Directrice Marketing", quote: "Le programme L'Orateur Influent a changé la façon dont je traite avec les clients. Je sais maintenant comment transmettre mon idée en quelques secondes et laisser une vraie impression dans n'importe quelle réunion." },
