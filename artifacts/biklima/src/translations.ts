...
export const T = {
  ar: {
    ...
    footer: {
      ...
      linkLabels: { structure: "البرامج التدريبية", wisdom: "مقالات", workbooks: "الكراسات", testimonials: "آراء العملاء" },
  ...
  en: {
    ...
    footer: {
      ...
      linkLabels: { structure: "Training Programs", wisdom: "Articles", workbooks: "Workbooks", testimonials: "Reviews" },
  ...
  fr: {
    ...
    footer: {
      ...
      linkLabels: { structure: "Programmes de Formation", wisdom: "Articles", workbooks: "Cahiers", testimonials: "Avis" },
