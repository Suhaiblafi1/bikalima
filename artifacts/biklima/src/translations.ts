...
export const T = {
  ar: {
    ...
    modal: {
      ...
      courseContentHeading: "محتوى البرنامج",
      freePreviewBadge: "معاينة مجانية",
      lessonsUnit: "درس",
      sectionsUnit: "قسم",
      enrollNowBtn: "سجّل في البرنامج الآن",
      enrollFormTitle: "أنشئ حسابك وسجّل الآن",
      enrollFormLoggedInTitle: "التسجيل في البرنامج",
      firstName: "الاسم الأول",
      lastName: "الاسم الأخير",
      email: "البريد الإلكتروني",
      phone: "رقم الهاتف",
      password: "كلمة المرور",
      trainingMode: "نوع التدريب",
      reason: "سبب انضمامك (اختياري)",
      submitEnroll: "أنشئ حسابك وسجّل",
      submitEnrollLoggedIn: "تسجيل في البرنامج",
      enrollSuccess: "تم استلام طلبك! 🎉",
      enrollSuccessMsg: "سنراجع طلبك ونتواصل معك خلال ٢٤–٤٨ ساعة لتأكيد التفاصيل.",
      enrollGoToDashboard: "ادخل إلى لوحتك",
      enrollAlreadyUser: "لديك حساب بالفعل؟",
      enrollLoginLink: "سجّل الدخول",
      emailExists: "هذا البريد الإلكتروني مسجّل مسبقاً. سجّل الدخول بدلاً من ذلك.",
    },
  },
  ...
  en: {
    ...
    modal: {
      ...
      courseContentHeading: "Program Content",
      freePreviewBadge: "Free Preview",
      lessonsUnit: "lesson",
      sectionsUnit: "section",
      enrollNowBtn: "Register for This Program",
      enrollFormTitle: "Create Account & Register",
      enrollFormLoggedInTitle: "Register for Program",
      ...
      submitEnroll: "Create Account & Register",
      submitEnrollLoggedIn: "Register for Program",
      enrollSuccess: "Request Received! 🎉",
      enrollSuccessMsg: "We'll review your request and reach out within 24–48 hours to confirm details.",
      enrollGoToDashboard: "Go to My Dashboard",
      enrollAlreadyUser: "Already have an account?",
      enrollLoginLink: "Sign in",
