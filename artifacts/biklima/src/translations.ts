...
export const T = {
  ar: {
    ...
    gallery: {
      heading: "الأفواج السابقة",
      sub: "دورات أُقيمت في ٧ دول حول العالم — قطر، الإمارات، السودان، الأردن، روسيا، المملكة المتحدة، والسعودية.",
    ...
    videos: {
      ...
      sub: "خطابات مختارة للاستلهام والتعلم — شاهد كيف تُصنع الكلمة أثراً حقيقياً.",
  ...
  en: {
    ...
    gallery: {
      heading: "Past Cohorts",
      sub: "Training held in 7 countries around the world — Qatar, UAE, Sudan, Jordan, Russia, the UK, and Saudi Arabia.",
    ...
    videos: {
      ...
      sub: "Curated speeches for inspiration and learning — see how words create real impact.",
  ...
  fr: {
    ...
    structure: {
      ...
      coreSubtitle: "L'Art de l'Influence et l'Art Oratoire",
      hoursUnit: "heures",
    ...
    enroll: {
      ...
      modeCombined: "Enregistré & Live",
      modeCombinedSub: "Sync — enregistré ou live",
      modeGroupInPerson: "Présentiel",
      modeGroupInPersonSub: "En personne sur place",
      modePrivate: "Privé 1:1",
      modePrivateSub: "Formation intensive",
      nameLabel: "Nom Complet",
      ...
      sidePanelTitle: "Votre Voix Est un Outil.\nServez-vous en pour tout changer.",
      sidePanelText: "Chaque grand accomplissement a commencé par un seul pas. Notre équipe est là pour accompagner votre transformation — du premier mot à un impact durable.",
      quickQ: "Questions rapides ?",
      sidePanelStep1: "Postuler",
      sidePanelStep1Desc: "Soumettez votre demande",
      sidePanelStep2: "Orientation",
      sidePanelStep2Desc: "On vous guide vers le bon programme",
      sidePanelStep3: "Démarrer",
    ...
    gallery: {
      heading: "Promotions Passées",
      sub: "Des formations menées dans 7 pays à travers le monde — Qatar, Émirats, Soudan, Jordanie, Russie, Royaume-Uni et Arabie Saoudite.",
    ...
    videos: {
      ...
      sub: "Discours sélectionnés pour l'inspiration et l'apprentissage — voyez comment les mots créent un impact réel.",
