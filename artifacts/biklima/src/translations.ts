...
export const T = {
  ...
  en: {
    ...
    trainerBio: {
      ...
      title: "Founder of Biklima · TEDx Speaker · Public Speaking Trainer",
      bio: "A specialist trainer in the art of public speaking and delivery, TEDx speaker, and author of the Biklima training workbook series. He has delivered dozens of programs and speeches across Jordan and the Arab world, training hundreds of participants of all ages and backgrounds. He believes that every person carries a message worth hearing, and that a confident word is the most powerful tool for change.",
    },
    author: {
    ...
    faq: {
      ...
      items: [
        ...
        { q: "How does the children's program reach schools?", a: "The 'Young Speaker' program is delivered to schools exclusively through certified graduates of Biklima's Educators & Parents program." },
    ...
    enroll: {
      ...
      workbookCountLabel: "Number of Workbooks Needed (optional)",
  ...
  fr: {
    ...
    wisdom: {
      ...
      heading: "La Philosophie de Biklima",
    ...
    faq: {
      ...
      items: [
        ...
        { q: "Comment le programme enfants atteint-il les écoles ?", a: "Le programme 'Jeune Orateur' est dispensé aux écoles exclusivement par les diplômés certifiés de Biklima." },
    ...
    enroll: {
      ...
      workbookCountLabel: "Nombre de Cahiers Nécessaires (optionnel)",
