import { HOME_SECTION_KEYS, type SectionContent, type SectionKey } from "./sections-schema";

// Seed defaults pulled from translations.ts. These mirror the visible copy
// of the existing home page so the CMS can be auto-seeded with sensible
// values (admins then edit only what they want to change).
...
// Sanity check at module load (dev-only; cheap).
