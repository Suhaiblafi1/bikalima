...
const DEFAULT_BADGES: Array<{
  ...
  // ── Little Speaker (kids platform) badges ────────────────────────────
  {
    key: "voice_clear",
    titleAr: "صوت واضح",
    titleEn: "Clear Voice",
    descriptionAr: "تكلّمت بصوت واضح في تسجيلك الأول.",
    descriptionEn: "You spoke clearly in your first voice recording.",
    icon: "mic",
    colorClass: "bg-pink-100 text-pink-700",
    eventName: "kid_voice_clear",
    displayOrder: 10,
  },
  {
    ...
    descriptionAr: "أعطيت نفسك تقييمًا عاليًا في الثقة.",
    descriptionEn: "You rated yourself highly on confidence.",
    icon: "smile",
    colorClass: "bg-amber-100 text-amber-700",
    eventName: "kid_confident_speaker",
    displayOrder: 11,
  },
  {
    key: "strong_start",
    ...
    descriptionAr: "أكملت أول نشاط في رحلتك.",
    descriptionEn: "You completed your first activity.",
    icon: "sparkles",
    colorClass: "bg-sky-100 text-sky-700",
    eventName: "kid_strong_start",
    displayOrder: 12,
  },
  {
    key: "little_leader",
    titleAr: "قائد صغير",
    titleEn: "Little Leader",
    descriptionAr: "أكملت ٥ أنشطة مختلفة.",
    descriptionEn: "You completed 5 different activities.",
    icon: "crown",
    colorClass: "bg-violet-100 text-violet-700",
    eventName: "kid_little_leader",
    displayOrder: 13,
  },
  {
    ...
    descriptionAr: "أنجزت تحدياً صعباً بنجاح.",
    descriptionEn: "You finished a challenge activity.",
    icon: "trophy",
    colorClass: "bg-emerald-100 text-emerald-700",
    eventName: "kid_challenge_champion",
    displayOrder: 14,
  },
];
