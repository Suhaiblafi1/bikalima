  ...
  try {
    for (const course of courses) {
      ...
      if (existing.rows.length > 0) {
        await client.query(
          `UPDATE courses SET slug=$1, title_ar=$2, title_en=$3, title_fr=$4, description_ar=$5, description_en=$6, image_url=$7, price=$8, recorded_price=$8, delivery_formats='["recorded","zoom","blended"]'::jsonb, is_published=$9, updated_at=NOW()
           WHERE program_id=$10`,
        ...
        await client.query(
          `INSERT INTO courses (program_id, slug, title_ar, title_en, title_fr, description_ar, description_en, image_url, price, recorded_price, delivery_formats, is_published)
           VALUES ($1, $2, $3, $4, $5, $6, $7, $8, $9, $9, '["recorded","zoom","blended"]'::jsonb, $10)`,
