...
import { db, ordersTable, coursesTable, enrollmentsTable } from "../db.js";
...
<div dir="rtl" style="font-family:Tajawal,Arial,sans-serif;max-width:600px;margin:auto;background:#f9f7f2;border-radius:12px;overflow:hidden">
  ...
  <div style="padding:24px 28px;background:#fff;border-radius:0 0 12px 12px">
    <table style="width:100%;border-collapse:collapse;font-size:15px">
      ...
      <tr><td style="padding:8px 0;color:#555">المبلغ</td><td style="padding:8px 0;font-weight:bold;color:#25786A">${course.price || "—"} JOD</td></tr>
...
<div dir="rtl" style="font-family:Tajawal,Arial,sans-serif;max-width:600px;margin:auto;background:#f9f7f2;border-radius:12px;overflow:hidden">
  ...
  <div style="padding:24px 28px;background:#fff;border-radius:0 0 12px 12px">
    ...
    <div style="margin:20px 0;padding:16px;background:#f0faf7;border-radius:8px;border-right:4px solid #25786A">
      <p style="margin:0;font-size:13px;color:#25786A;font-weight:bold">المبلغ المطلوب: ${course.price || "—"} دينار أردني</p>
    </div>
